...
import { CreditCard, ArrowRight, History, Lock, CheckCircle, Clock, XCircle, Calendar, DollarSign } from "lucide-react";
...
function PaymentHistory({ onNavigateToPayment }) {
  ...
  const getStatusIcon = (status) => {
    ...
    if (["confirmed", "completed", "success"].includes(statusLower)) {
  ...
  const filteredPayments = payments.filter(p => {
    ...
    if (filter === "completed") {
      return ["confirmed", "completed", "success"].includes(status);
    }
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">Track all your international transactions</p>
            </div>
            <button
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {filteredPayments.length === 0 ? (
          <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-16 text-center">
            <History className="mx-auto text-gray-700 mb-4" size={64} />
            <h3 className="text-2xl font-bold text-gray-300 mb-2">No Payments Found</h3>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 text-gray-400">
                        ...
                        <span className="text-white font-mono text-sm">{payment.toAccount}</span>
                      </div>
                      ...
                      {payment.card && (
                        <div className="flex items-center gap-2 text-gray-400">
                          ...
                          <span className="text-sm">
                            {payment.card.cardHolder} •••• {payment.card.cardNumber?.slice(-4)}
                          </span>
                        </div>
                      )}
